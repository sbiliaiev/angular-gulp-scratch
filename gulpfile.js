...
//     return plugins.order(['bootstrap.css']);
// };
...
gulp.task('watch-dev', ['clean-build-app-dev', 'build-app-dev', 'validate-devserver-scripts'], function() {
...
gulp.task('default', ['watch-dev', 'webserver']);
